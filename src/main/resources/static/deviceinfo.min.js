/*
 * Portions Copyrighted Koninklijke Philips Electronics N.V. 2019
 * 
 */
...
// Getting geolocation takes some time and is done asynchronously, hence
// need a callback which is called once geolocation is retrieved.
...
collectHsdpInfo = function () {

  if (!localStorage.getItem("hsdpDeviceID")) {

    localStorage.setItem("hsdpDeviceID", generateUUID());
  }
  return localStorage.getItem("hsdpDeviceID");;
},
